...
namespace NorthWind.WebExceptionsPresenter
{
    public class ExceptionHanlderBase
    {
        readonly Dictionary<int, string> RFC7231Types = new Dictionary<int, string> {
            ...
            "http://datatracker.ietf.org/doc/html/rfc7231#section-6.6.1"
            ...
            "http://datatracker.ietf.org/doc/html/rfc7231#section-6.5.1"
        ...
        public Task SetResult(ExceptionContext context, int?
